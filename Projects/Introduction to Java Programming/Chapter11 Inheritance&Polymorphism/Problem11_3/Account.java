...
public class Account {
    protected static int NUMBER_OF_ACCOUNTS;      // Number of Accounts
    protected int id;                             // Account ID
    protected double balance;                     // Account Balance
    protected static double annualInterestRate;   // Annual Interest Rate (Common for all accounts)
    protected Date dateCreated;                   // Date the account was created
